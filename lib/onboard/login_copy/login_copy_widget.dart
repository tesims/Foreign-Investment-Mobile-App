                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      _model.authToken = await LoginCall.call(
                                        email:
                                            _model.emailAddressController.text,
                                        password:
                                            _model.passwordController.text,
                                      );
                                      if ((_model.authToken?.succeeded ??
                                              true) ==
                                          true) {
                                        setState(() {
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      _model.apiResultzpg =
                                          await GoogleInitCall.call();
                                      if ((_model.apiResultzpg?.succeeded ??
                                          true)) {
                                        await launchURL(GoogleInitCall.authURL(
                                          (_model.apiResultzpg?.jsonBody ?? ''),
                                        ).toString());
                                      }
